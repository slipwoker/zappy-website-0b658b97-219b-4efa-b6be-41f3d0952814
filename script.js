    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Finera.com uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '0b658b97-219b-4efa-b6be-41f3d0952814',
                    name: data.name || '',
                    email: data.email || '',
